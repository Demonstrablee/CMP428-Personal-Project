...
public class LevelBuilderPanel extends JPanel implements KeyListener, Runnable{
    ...
    MurphysRoom2 murphysRoom2 = new MurphysRoom2(new Wall[]{new Wall(100, 10, 600, 80),new Wall(150, 500, 100, 150),new Wall(790, 70, 100, 150)});
    protected Wall [] wall = murphysRoom2.getWalls();
