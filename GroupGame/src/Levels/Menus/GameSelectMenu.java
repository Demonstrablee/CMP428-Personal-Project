...
public class GameSelectMenu extends Level implements MouseListener {
    ...
    String[] descriptions = new String[] {
            ...
            "<html> As a plumber of the International Space Station your countries astronauts need you. Take up a wrench against time and lay a path before outer space is wasted!</html>",
